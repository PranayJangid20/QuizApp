...
class TestPage extends StatefulWidget {
  const TestPage({Key? key, required this.totalQuetion, required this.correctPoint, required this.wrongPoint})
      : super(key: key);
...
class _TestPageState extends State<TestPage> {
  ...
  void initState() {
    ...
    context.read<TestCubit>().fetchQuestions(
        totalTQuestions: widget.totalQuetion,
    ...
    return BlocBuilder<TestCubit, TestState>(
      builder: (context, state) {
        return Scaffold(
          ...
          body: state is DataUpdatedState
              ? Column(
                  children: [
                    Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Align(
                              ...
                              child: Text(
                                'Q : ${state.current}/${widget.totalQuetion}',
                            ...
                            StepProgressIndicator(
                              totalSteps: widget.totalQuetion,
